...
function select( payload ){
  ...
  if( _.find( representations, function( representation ){
      return (representation.rankType === "to rank" && _.get( representation, "compared.length", 0 ) < _.get( assessment, "comparisonsNum.perRepresentation", 10 ));
    } ) ){
    ...
    var maxComp = _.get( assessment, "comparisonsNum.perAssessor[0]", 5 );
    ...
    switch( assessment.stage ){
      case 0:
        ...
        break;
      case 1:
        if( numCompJudge( comparisons, assessor ) >= maxComp + _.get( assessment, "comparisonsNum.perAssessor[1]", 17 ) ){
