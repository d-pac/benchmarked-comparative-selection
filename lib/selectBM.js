...
module.exports = function selectBM( representations,
  ...
  if( !representationA.comparedNum ){
    ...
    if( unusedBenchmarkIds.length ){
      ...
      var representationsCloseToSorted = _.sortBy( _.filter( representations, { closeTo: selectedBenchmarkId } ), "comparedNum" );
      var representationsRange = _.filter( representationsCloseToSorted, { comparedNum: representationsCloseToSorted[ 0 ].comparedNum } );
